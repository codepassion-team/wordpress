...
function ecommerce_landing_page_activation_notice() {
	...
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/landing-page-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'ecommerce-landing-page' ) .'</a></span>';
	echo '</div>';
}
...
define('ECOMMERCE_LANDING_PAGE_BUY_NOW',__('https://www.vwthemes.com/themes/landing-page-wordpress-theme/','ecommerce-landing-page'));
...
define('ECOMMERCE_LANDING_PAGE_CREDIT',__('https://www.vwthemes.com/themes/free-ecommerce-landing-page-templates/','ecommerce-landing-page'));
