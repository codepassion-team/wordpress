jQuery(document).ready(function($) {
    'use strict';
    var this_obj = medical_landing_page_plugin_activate_plugin;
    ...
    $(document).on('click', '.medical-landing-page-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message medical-landing-page-plugin-install');
                button.addClass('button-primary medical-landing-page-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.medical-landing-page-recommended-plugins .medical-landing-page-activation-note').css('display','block');
    ...
    $(document).on('click', '.medical-landing-page-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .medical-landing-page-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .medical-landing-page-recommended-plugins').css('display','none');
    });
