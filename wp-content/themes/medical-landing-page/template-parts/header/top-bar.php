...
<div class="topbar">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-2 col-md-2 col-6 align-self-center text-lg-end text-md-start text-center">
        <?php if(class_exists('woocommerce')){ ?>
          ...
          <?php }
            ...
            <a class="myaccount-icon" href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>" title="<?php esc_attr_e('Login / Register','medical-landing-page'); ?>"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_landing_page_topbar_myaccount_icon','fas fa-user')); ?>"></i><span class="screen-reader-text"></span></a>
          <?php } ?>
        <?php }?>
      </div>
    </div>
